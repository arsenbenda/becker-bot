...
- [x] 1.7 Auto-retire Layer 1 (when L2 outperforms by >2pp MAE) — P13b+P18: L1 retired for sports/politics/crypto/geopolitics
...
**Phase 1 status:** 19/21 complete. Remaining: 1.3, 1.6, 1.10, 1.11 (1.8 deferred). L1 now retired for all 4 major categories (P13b+P18).
